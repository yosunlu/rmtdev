...
const submitHandler = event => {
    ...
    // validation (regex expression example)
                        ...
                        <a class="job-item__link" href="${jobItem.id}">
                            ...
                            <div class="job-item__middle">
                                ...
                                <div class="job-item__extras">
                                    <p class="job-item__extra"><i class="fa-solid fa-clock job-item__extra-icon"></i>${jobItems[4].id.duration}</p>
                                    <p class="job-item__extra"><i class="fa-solid fa-money-bill job-item__extra-icon"></i>${jobItems[4].id.salary}</p>
                                    <p class="job-item__extra"><i class="fa-solid fa-location-dot job-item__extra-icon"></i> ${jobItems[4].id.location}</p>
                                </div>
                            </div>
                ...
                <div class="job-details__other">
                    <section class="qualifications">
                        ...
                        <ul class="qualifications__list">
                            ${jobItem.qualifications.map(qualificationText => `<li class="qualification__item">${qualificationText}</li>`).join('')}
